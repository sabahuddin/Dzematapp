...
export default function ModulesPage() {
  ...
  const modules: ModuleItem[] = [
    ...
    { icon: <EmojiEvents sx={{ fontSize: 48 }} />, label: 'Priznanja', description: 'Značke i zahvalnice', route: user?.isAdmin ? '/certificates' : '/my-certificates', testId: 'module-recognition' },
