...
export default function SectionsScreen() {
  ...
  if (loading) {
    return (
      <>
        <Stack.Screen options={{ title: 'Sekcije', headerStyle: { backgroundColor: AppColors.primary }, headerTintColor: AppColors.white }} />
...
const styles = StyleSheet.create({
  ...
  cardIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: `${AppColors.primary}15`, justifyContent: 'center', alignItems: 'center', marginRight: Spacing.md },
  cardContent: { flex: 1 },
  cardTitle: { fontSize: Typography.fontSize.lg, fontWeight: Typography.fontWeight.semibold, color: AppColors.textPrimary, marginBottom: Spacing.xs },
  cardDescription: { fontSize: Typography.fontSize.sm, color: AppColors.textSecondary },
});
